  ...
  return (
    ...
    <div className='flex flex-col items-center '>
           <div className='flex flex-col items-center justify-center mt-10 '>
                <div className=' flex justify-center items-center w-full max-w-[900px] gap-x-180 flex-row mb-20'>
           ...
           <div className='flex flex-col items-center songInfo glass-white w-120 mt-20 h-auto'>
           ...
           <div className='tracklist flex flex-row  justify-between gap-x-30'>
               {/* */}
               <div className='musicscrubber glass-white w-150 mt-15 h-4 '>
           ...
           <div className='musicControlBar w-auto h-auto glass-white mt-20 '>
               <div className='controlBar flex items-center flex-row justify-between gap-x-5 mt-5 px-5 mb-5'>
